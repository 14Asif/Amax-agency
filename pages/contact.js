        ...
        <div className="absolute bottom-0 left-0 right-0 top-0 h-full w-full overflow-hidden bg-fixed backShade">
          <div className="flex h-full items-center justify-center">
            <div className="text-white">
              <h2 className="mb-4 text-4xl text-white-500 font-semibold">
                Connect With US
              </h2>
      ...
      <section className="bg-white dark:bg-gray-900">
        <div className="py-12 lg:py-12 px-4 mx-auto max-w-screen-md">
          ...
          <p className="mb-8 lg:mb-16 font-light text-center text-blue-300 dark:text-gray-400 sm:text-xl">
            Share your hurdles for growth with us, and we’ll produce a strategy
            to solve them.
          </p>
          <form onSubmit={handleSubmit} className="space-y-8">
            <div>
              <label
                htmlFor="email"
                className="block mb-2 text-base text-blue-300 font-medium text-gray-900 dark:text-gray-300"
              >
                Your Name
              </label>
              <input
